            ...
            {currentView === 'settings' && (
                <div className="animate-slide-in max-w-3xl pb-4">
                     ...
                     <div className="bg-white dark:bg-[#1E1E1E] rounded-[32px] border border-gray-100 dark:border-white/10 p-6 md:p-8 shadow-sm space-y-6 md:space-y-8 transition-colors">
                        ...
                        <div className="flex items-center justify-between pb-6 border-b border-gray-50 dark:border-white/5">
                            <div className="flex items-center gap-4">
                                <div className="bg-gray-100 dark:bg-white/5 p-3 rounded-full">
                                    <User className="w-5 h-5 text-gray-700 dark:text-gray-300" />
                                </div>
                                <div>
                                    <h3 className="font-medium text-base md:text-lg dark:text-white">Profil</h3>
                                    <p className="text-xs md:text-sm text-gray-400">Gérez vos informations personnelles</p>
                                </div>
                            </div>
                            <button className="text-xs md:text-sm border border-gray-200 dark:border-white/20 px-3 md:px-4 py-2 rounded-full hover:bg-gray-50 dark:hover:bg-white/5 dark:text-white">Modifier</button>
                        </div>
                        ...
                        <div className="flex items-center justify-between pb-6 border-b border-gray-50 dark:border-white/5">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-medium text-base md:text-lg dark:text-white">Notifications</h3>
                                    <p className="text-xs md:text-sm text-gray-400">Alertes emails et push</p>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between pb-6 border-b border-gray-50 dark:border-white/5">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-medium text-base md:text-lg dark:text-white">Langue</h3>
                                    <p className="text-xs md:text-sm text-gray-400">Langue de l'interface et de l'IA</p>
                                </div>
                            </div>
                            <span className="text-xs md:text-sm font-bold bg-gray-50 dark:bg-white/5 px-3 py-1 rounded-lg dark:text-white">Français (FR)</span>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-medium text-base md:text-lg dark:text-white">Sécurité</h3>
                                    <p className="text-xs md:text-sm text-gray-400">Mot de passe et 2FA</p>
                                </div>
                            </div>
                            <button className="text-xs md:text-sm border border-gray-200 dark:border-white/20 px-3 md:px-4 py-2 rounded-full hover:bg-gray-50 dark:hover:bg-white/5 dark:text-white">Configurer</button>
                        </div>
